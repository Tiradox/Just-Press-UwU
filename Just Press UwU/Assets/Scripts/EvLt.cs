...
public class EvLt : MonoBehaviour
{
    [Header("Windows")]
    ...
    public IEnumerator Mbutton()
    {
        ...
        if(WTD == 0)
        {
            ...
            StartCoroutine(DS.TxtAnimation(fileLines, 0, imPlayer, 0.03f, GM, true));
            WTD = 1;
        }
        else if (WTD == 1)
        {
            ...
            StartCoroutine(DS.TxtAnimation(fileLines, 1, imPlayer, 0.5f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 2, imPlayer, 0.1f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 3, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 4, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 5, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 6, imPlayer, 0.1f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 7, imPlayer, 0.05f, GM, false));
            ...
            StartCoroutine(DS.TxtAnimation(fileLines, 8, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 9, imPlayer, 0.1f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 10, imPlayer, 0.05f, GM, false));
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 11, imPlayer, 0.05f, int.Parse(fileLines[10 * 3]), GM, false));
            ...
            yield return new WaitForSeconds(2f);
            StartCoroutine(DS.TxtAnimation(fileLines, 12, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 13, imPlayer, 0.05f, GM, true));
        ...
        else if (WTD == 2)
        {
            ...
            StartCoroutine(DS.TxtAnimation(fileLines, 14, imPlayer, 0.03f, GM, false));
            ...
            StartCoroutine(DS.TxtAnimation(fileLines, 15, imPlayer, 0.03f, GM, false));
            ...
            yield return new WaitForSeconds(0.6f);
            StartCoroutine(DS.TxtAnimation(fileLines, 16, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(1f);
            StartCoroutine(DS.TxtAnimation(fileLines, 17, imPlayer, 0.1f, GM, false));
            yield return new WaitForSeconds(0.6f);
            StartCoroutine(DS.TxtAnimation(fileLines, 18, imPlayer, 0.03f, int.Parse(fileLines[17 * 3]), GM, false));
            ...
            yield return new WaitForSeconds(0.6f);
            StartCoroutine(DS.TxtAnimation(fileLines, 19, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(0.6f);
            StartCoroutine(DS.TxtAnimation(fileLines, 20, imPlayer, 0.05f, GM, false));
            ...
            yield return new WaitForSeconds(0.6f);
            StartCoroutine(DS.TxtAnimation(fileLines, 21, imPlayer, 0.05f, GM, false));
